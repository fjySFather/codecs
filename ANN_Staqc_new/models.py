...
from tensorflow.keras.layers import Input, Embedding, Dropout, Lambda, Activation, Dense, GlobalAveragePooling1D, Dot, Bidirectional, GRU
import pickle
...
class CodeMF:
    ...
    def build(self):
        ...
        # 融合语义
        sentence_token_level_outputs = MediumLayer()([text_S1_Semantic, text_S2_Semantic, queries_semantic, code_semantic])
